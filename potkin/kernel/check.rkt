  ...
  (list
   (lambda (left right recur)
     (and (checked-node? right)
          (recur (checked-node-calculus left)
                 (checked-node-calculus right))
  ...
  (list
   (lambda (left right recur)
     (and (checked-hole? right)
          (recur (checked-hole-calculus left)
                 (checked-hole-calculus right))
          (recur (checked-hole-boundary left)
                 (checked-hole-boundary right))))
   (lambda (value recur)
     (recur (list (checked-hole-calculus value)
                  (checked-hole-boundary value))))
   (lambda (value recur)
     (recur (list (checked-hole-boundary value)
                  (checked-hole-calculus value))))))
